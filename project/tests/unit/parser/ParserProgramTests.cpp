...
//		auto primitiveType = dynamic_cast<ast::PrimitiveTypeNode *>(typeNode);
//		ASSERT_NE(primitiveType, nullptr);
//		EXPECT_EQ(primitiveType->getKind(), expectedKind);
//	}
//
//	// Helper function to check a pointer type
//	ast::PointerTypeNode *checkPointerType(ast::ASTNode *typeNode) {
//		auto pointerType = dynamic_cast<ast::PointerTypeNode *>(typeNode);
//		ASSERT_NE(pointerType, nullptr);
//		return pointerType;
//	}
//
//	// Helper function to get base type of a pointer
//	ast::ASTNode *getPointerBaseType(ast::PointerTypeNode *pointerType) {
//		return pointerType->getBaseType().get();
//	}
//}
//
///**
...
//		auto pointerType = checkPointerType(varDecl->getType().get());
//		auto baseType = getPointerBaseType(pointerType);
...
//		auto pointerType1 = checkPointerType(varDecl->getType().get());
//		auto baseType1 = getPointerBaseType(pointerType1);
//		auto pointerType2 = checkPointerType(baseType1);
//		auto baseType2 = getPointerBaseType(pointerType2);
//		checkPrimitiveType(baseType2, ast::PrimitiveTypeNode::Kind::INT);
//	}
//
...
//		auto pointerType2 = checkPointerType(baseType1);
//		auto baseType2 = getPointerBaseType(pointerType2);
//		auto pointerType3 = checkPointerType(baseType2);
//		auto baseType3 = getPointerBaseType(pointerType3);
//		checkPrimitiveType(baseType3, ast::PrimitiveTypeNode::Kind::DOUBLE);
//	}
//}
//
///**
...
//		auto pointerType2 = checkPointerType(baseType1);
//		auto baseType2 = getPointerBaseType(pointerType2);
//		checkPrimitiveType(baseType2, ast::PrimitiveTypeNode::Kind::VOID);
//	}
//}
//
///**
...
//		auto baseType = checkPointerType(varDecl->getType().get());
//		checkPrimitiveType(baseType, ast::PrimitiveTypeNode::Kind::INT);
//		ASSERT_NE(varDecl->getArraySize(), nullptr);
//	}
//}
...
//		auto returnPointerType = checkPointerType(funcPtrDecl->getReturnType().get());
//		auto returnBaseType = getPointerBaseType(returnPointerType);
...
//		checkPrimitiveType(funcPtrDecl->getParameterTypes()[0].get(), ast::PrimitiveTypeNode::Kind::INT);
//
//		auto paramPointerType = checkPointerType(funcPtrDecl->getParameterTypes()[1].get());
//		auto paramBaseType = getPointerBaseType(paramPointerType);
